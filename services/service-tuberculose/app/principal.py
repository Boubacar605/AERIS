"""Point d'entree FastAPI du service de detection de la tuberculose."""
...
async def cycle_de_vie(app: FastAPI):
    ...
    logger.info("Demarrage du service tuberculose (mode: %s)", config.mode_deploiement)
    charger_modele()
    yield
    logger.info("Arret du service tuberculose")


app = FastAPI(
    title="AERIS — Service Tuberculose",
    description="Service d'inference IA pour la detection de la tuberculose par radiographie thoracique.",
    version="0.1.0",
