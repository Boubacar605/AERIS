...
TODO: Integrer le modele Keras/TensorFlow (.h5 ou SavedModel)
      pour la classification pneumonie (dataset Chest X-Ray).
"""
...
async def preprocesser_image(contenu_image: bytes) -> np.ndarray:
    ...
    TODO: Implementer le redimensionnement, normalisation, conversion niveaux de gris.
    """
